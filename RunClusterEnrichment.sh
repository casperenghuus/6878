...
# echo $clusterfiles
python2 ClusterEnrichment.py $clusterfiles --nodes $opdir/nodes.txt --msigprefix Gene4x/msigdb/ --outfile $opdir/overview_5.csv --graphs $opdir/net_* --thresholds $opdir/p_cut_offs.csv
