...
def run_method_given_folder_and_network(folder_name, program_number, seed, run_number):
    ...
    os.system("mv network_file_cvis_" + str(run_number) + "/cvis_*.gdf results_"+str(run_number))
    os.system("rm -r network_file_cvis_" + str(run_number))

    os.chdir(current_dir)
    print 'run ', run_number, 'done!'
    return [1]
